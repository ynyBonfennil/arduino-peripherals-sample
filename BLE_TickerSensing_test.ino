...
void sensing_task_handle(void) {
  ...
  Wire.end();   // this function does nothing, actually. It is needed to stop the clock somewhere.
}
...
void setup() {
  ...
  // Low Power Setting ( please refer to https://fabo.gitbooks.io/bledocs/content/nordic/lowenergy.html )
  // NRF_UART0->POWER = 0;
  ...
  ticker1s.attach(sensing_task_handle, 3);
